/*
 * PDFObject, copyright (C) 2008 Philip Hutchison (pipwerks.com). Documentation
 * and examples are at www.pdfobject.com. Version 1.2, April 2011. MIT style
 * license
 */

define('PDFObject',[], function () {

    function PDFObject (y) {
        if (!y || !y.url) {
            return false;
        }
